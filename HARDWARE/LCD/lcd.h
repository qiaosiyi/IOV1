...
void gui_draw_bline1(u16 x0,u16 y0,u16 x1,u16 y1,u8 size,u16 color);		//画一条粗线，size：粗细1-2。
void gyro_circle_panel(u16 x,u16 y,u16 r,u16 d);							//画一个圆形表盘,x,y:坐标中心点，r:表盘大小(半径)，d:表盘刻度
void gyro_circle_show(u16 x,u16 y,u16 size,u16 d,s16 arg,u16 color);		//画指针；x,y:坐标中心点
void showxylinepo(short x1,short y1,short x2,short y2,short color);
